...
class MCPDataset():
    def __init__(self):
        ...
        graphImg, ecfp, hash,list_of_node,list_of_edge, list_of_pos, label = readData.all_data()
        self.Y = label
        dict_data = {'graphImg': graphImg, 'ecfp': ecfp,'hash': hash,
                     "list_of_node":list_of_node,"list_of_edge":list_of_edge,"list_of_pos":list_of_pos,'label': label}
